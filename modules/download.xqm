...
module namespace download="http://joewiz.org/ns/xquery/download";
...
declare function download:http-download($file-url as xs:string, $collection as xs:string) as item()* {
